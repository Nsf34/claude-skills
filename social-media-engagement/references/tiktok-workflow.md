...
## Discovery: For You Page (FYP)

The FYP is the primary discovery method. It surfaces fresh, relevant content every session and gives natural variety without searching.
...
- **Search:** Look for keywords matching the brand's content themes (e.g., "pottery", "ceramic mug", "pour over coffee", "handmade crafts"). Vary search terms across sessions.
...
Most sessions should lean on the FYP. Mix in others for variety.
