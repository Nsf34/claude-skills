...
3. **Match the energy of the post.** A polished studio shot gets a more refined comment. A messy first-try video gets warm encouragement. A morning ritual post gets cozy energy.

4. **Keep it natural length.** Platform-specific (see below), but always: shorter is better. Never write a paragraph.

5. **Use emojis sparingly.** 0-1 emoji per comment max. Never lead with an emoji. Never use more than one. Skip them entirely on about half your comments.
...
- **NEVER** mention the brand's products in comments. This instantly looks like spam.
- **NEVER** repeat a comment within a session. Every comment must be unique.
- **NEVER** write generic comments: "Great post!", "Love this!", "Amazing!", "So good!", "Fire!"
...
**Length:** 1-2 sentences max. 1 sentence is ideal. Instagram comments are short and punchy.

**Tone:** Casual, concise, texting-a-friend energy. Lowercase is fine. Fragments are fine.

**Style Distribution:**
- **40% Genuine compliments** -- specific praise about what you see
- **30% Curious questions** -- ask about technique, materials, process
- **20% Relatable reactions** -- express a feeling the post evokes
- **10% Encouraging/supportive** -- for progress posts, first attempts, personal milestones

**Examples by Content Type** (for tone reference only, never copy verbatim):

*Pottery/ceramics:*
- "that glaze is unreal"
- "the form on this is so clean wow"
- "obsessed with this texture"
- "how long have you been throwing?"
- "makes me want to get back on the wheel"

*Coffee/lifestyle:*
- "ceramic + pour over just hits different"
- "that setup though"
- "what are you brewing?"
- "this is the morning routine i aspire to"

*DIY/craft:*
- "so satisfying to watch"
- "love seeing people get into clay"
...
**Length:** 1-3 sentences. 2 sentences is the sweet spot. Facebook's culture is more conversational than Instagram -- slightly longer comments feel natural here.

**Tone:** Warm, conversational, like talking to someone at a craft fair or community meetup. Still casual, but a bit more complete in thought than Instagram.

**Style Distribution:**
- **35% Genuine compliments** -- specific praise, slightly more detailed than Instagram
- **30% Curious questions** -- questions work especially well on Facebook because people expect more discussion in comments
- **20% Relatable reactions** -- express a feeling, share a brief related thought
- **15% Encouraging/supportive** -- Facebook Groups especially foster supportive communities, so encouraging comments land well

**Examples by Content Type** (for tone reference only, never copy verbatim):

*Pottery/ceramics:*
- "the way that glaze caught the light is beautiful. what cone did you fire to?"
- "this is incredible for your first year throwing, the centering is so clean"
- "love the shape on this. the proportions are really satisfying"

*Coffee/lifestyle:*
- "that setup is goals. do you notice a difference with the ceramic vs glass pour over?"
- "nothing beats a slow morning with a good cup"
- "this is making me rethink my whole morning routine"

*DIY/craft:*
- "this came out so well. what brand of clay are you using?"
...
When commenting in Groups, you can reference the group context (e.g., "love seeing this kind of work in this group"). This feels natural because Groups are communities, and referencing the community builds belonging.
...
**Never use:** Haha (can seem mocking), Wow (can seem sarcastic), Sad, Angry. These are too risky coming from a brand Page -- they're easily misinterpreted.

If you're unsure which reaction to use, default to **Like**. It's always safe.

---

## Adapting to Brand Context

The examples above are illustrative and lean toward pottery/ceramics/coffee themes. When a different brand context is loaded:

1. Read the brand context file to understand the brand's content themes, target customers, and voice
2. Adapt comment topics to match the brand's niche (e.g., a fitness brand would comment on workout posts, not pottery)
3. Match the brand voice description -- a playful brand sounds different from a refined brand
4. Keep the same structural rules (length, distribution, hard rules) regardless of brand
5. The comment should sound like a real person who works at/runs the brand, naturally engaging with content they genuinely care about
